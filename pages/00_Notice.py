...
**一、服務性質與報價說明**
1. 本表單僅供需求評估與初步報價參考使用，非正式契約。
2. 本方為個人提供之組裝與諮詢服務，非依法設立之商業登記店家，故無法提供統一發票或正式收據。
3. 所有配單建議與報價依當下市場行情浮動，最終價格以實際下單時為準。
4. 電腦組裝諮詢為免費提供，惟不代表保證成交或保留報價。
5. 雙方之交易內容與驗收標準，最終以電子報價單確認為準。
6. 客戶於電子報價單完成簽署、於電子郵件回覆確認，即視為契約成立。
7. 在未收到客戶電子郵件正式確認前，所有溝通內容均屬諮詢或討論階段，尚不構成訂單成立，本方亦無保留報價或零件之義務。
8. 本方所代購之零件，將依實際購買通路提供購買證明或發票影本（如原廠或通路商提供），以利後續保固或售後服務使用。
